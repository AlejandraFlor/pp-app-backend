...
module.exports = function(app) {
  ...
  app.post("/api/payment/getOnlyTimeTransactions", controller.getOnlyTimeTransactions)
  app.post("/api/payment/getRecurrentTransactions", controller.getRecurrentTransactions)
  ...
  app.post("/api/payment/createPaymentSubs", controller.createPaymentSubs)
  app.post("/api/payment/getPaymentSubs", controller.getPaymentSubs)
  app.post("/api/payment/getPaymentSubsE", controller.getPaymentSubsE)
  app.post("/api/payment/getPaymentSubsNE", controller.getPaymentSubsNE)
  app.post("/api/payment/deletePaymentSubs", controller.deletePaymentSubs)
  app.post("/api/payment/deletePaymentSubsFromSuggested", controller.deletePaymentSubsFromSuggested)
  app.post("/api/payment/modifyPaymentSubs", controller.modifyPaymentSubs)
  app.post("/api/payment/emmitPaymentSubs", controller.emmitPaymentSubs)
};